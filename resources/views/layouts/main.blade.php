...
<head>
    ...
    <title>UNIFRANZ | Universidad</title>
    ...
    <link href="{{ asset('template/src/assets/css/dark/scrollspyNav.css') }}" rel="stylesheet" type="text/css" />
</head>
...
&lt;/form&gt;
    ...
    <script src="{{ asset('template/layouts/modern-light-menu/app.j') }}s"></script>
